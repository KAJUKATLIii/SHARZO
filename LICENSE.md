...
Copyright (c) 2024 KAJUKATLIii

## Terms of Use

### 1. Grant of License
SHARZO is provided free of charge for personal and commercial use. You are permitted to:
- Use the software for personal entertainment and gaming
- Use the software for streaming and content creation
- Use the software for educational purposes
- Use the software for software development and testing
...
- Use the software to harm others or violate their privacy

### 3. Redistribution
You may redistribute the software under the following conditions:
- The software must remain unmodified
- All original files, including this license, must be included
- No fee may be charged for the software itself
- Attribution to the original author (kajukatli) must be maintained

### 4. Third-Party Components
SHARZO includes and uses the following third-party components:

#### scrcpy
- Copyright (C) 2018-2024 Genymobile, Genymobile/scrcpy
...
- Licensed under LGPL/GPL licenses
- https://ffmpeg.org/
...
IN NO EVENT SHALL kajukatli BE LIABLE FOR ANY SPECIAL, INCIDENTAL, INDIRECT, OR CONSEQUENTIAL DAMAGES WHATSOEVER (INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF BUSINESS PROFITS, BUSINESS INTERRUPTION, LOSS OF BUSINESS INFORMATION, OR ANY OTHER PECUNIARY LOSS) ARISING OUT OF THE USE OF OR INABILITY TO USE THE SOFTWARE, EVEN IF kajukatli HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
- Discord: https://discord.gg/ndw3XAbhrbuf

---

## Third-Party Licenses

### Apache License 2.0 (scrcpy, ADB)
```
